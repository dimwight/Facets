...
import static facets.core.app.AppConstants.TITLE_EDIT_MENU;
import static facets.core.app.AppConstants.TITLE_HELP_MENU;
import static facets.core.app.TextView.*;
import static facets.core.app.ViewerTarget.TARGETS_VIEWABLE;
import static facets.util.StringFlags.FLAG_NONE;
import static facets.util.StringFlags.newFlag;
import static facets.util.app.AppValues.PATH_APP;
/**
