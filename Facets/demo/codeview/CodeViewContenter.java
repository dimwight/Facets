...
import static demo.codeview.CodeViewConstants.*;
...
public abstract class CodeViewContenter extends ViewerContenter {	
	...
	@see facets.core.app.AppContenter#alignContentAreas(facets.core.superficial.app.SAreaTarget, facets.core.superficial.app.SAreaTarget)
	 */
